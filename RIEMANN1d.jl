...
@inline   function dfgod(pBig::Float64, p::Float64,rho::Float64, gamma::Float64)::Float64
...
@inline   function fgod( pBig::Float64, p::Float64,rho::Float64, gamma::Float64)::Float64
...
@inline   function computeRiemannFlux(rhoLeft::Float64,uLeft::Float64,pLeft::Float64,
		rhoRight::Float64, uRight::Float64,pRight::Float64,  Gamma::Float64)
...
@inline  function compute_1D_ARBITRARY_INVISCID_RIEMANN_FLUX_from_UPHYS(uLeft::Array{Float64,1}, uRight::Array{Float64,1}, nx::Float64,  ny::Float64, side::Float64, gamma::Float64)
	return compute_1D_ARBITRARY_INVISCID_RIEMANN_FLUX_from_UPHYS(uLeft[1],uLeft[2],uLeft[3],uLeft[4], uRight[1], uRight[2],uRight[3],uRight[4], nx,ny,side, gamma); 
end


@inline   function compute_1D_ARBITRARY_INVISCID_RIEMANN_FLUX_from_UPHYS(
...
@inline  function GOD1d(NCells::Int64, UPHSCELLS::Array{Float64,2}, Gamma::Float64)::Array{Float64,2}
